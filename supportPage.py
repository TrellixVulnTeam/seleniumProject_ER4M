...
class SupportPage(BaseSelenium):
    ...
    def click_on_link(self, link_id):
        click_on_link_id_sitem = \
            BaseSelenium.locator_finder_by_xpath(self, link_id)
    ...
    def manual_link(self):
        ...
        # fixme Data models & modeling | Manual | ArangoDB Documentation (3.6.16)
        # fixme Modeling Data for ArangoDB | ArangoDB Documentation (3.7.14), (3.9.0)
